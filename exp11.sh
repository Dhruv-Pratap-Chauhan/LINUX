#create a script that search the file for the specified directory and sub directory based on the certain criteria like file extension , file size, based on user path given info 
